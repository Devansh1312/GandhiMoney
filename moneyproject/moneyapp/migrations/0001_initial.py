    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='moneyapp.category')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('paymenttype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='moneyapp.paymenttype')),
            ],
        ),
        migrations.CreateModel(
            name='Credit',
            fields=[
                ...
                ('money', models.IntegerField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('payment_mode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='moneyapp.paymenttype')),
            ],
        ),
        migrations.CreateModel(
            name='Balance',
